    ...
    def open_camera(self):
        ...
        try:
            ...
            if not self.cap.isOpened():
                logger.log(f"Camera not accessible at index {CAMERA_INDEX}")
                return False
            
            # Use VERY LOW resolution for speed
            ...
            # Try to set MJPG for faster compression
            try:
            ...
            for _ in range(3):
                ...
                if ret:
                    ...
                    logger.log(f"Camera Connected ({actual_width}x{actual_height})")
                    return True
                time.sleep(0.05)
